...
transform_df = (news_dynamodb_node.toDF()
    ...
    .withColumn("neg_sentiment", coalesce(col("sentiment.neg"), col("sentiment.neg")))
    .withColumn("pos_sentiment", coalesce(col("sentiment.pos"), col("sentiment.pos")))
    .withColumn("neu_sentiment", coalesce(col("sentiment.neu"), col("sentiment.neu")))
    .withColumn("polarity_sentiment", coalesce(col("sentiment.polarity"), col("sentiment.polarity")))
